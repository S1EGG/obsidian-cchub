...
export function ImagePreviewStrip({
	...
	return (
		<div className="cchub-image-preview-strip">
			{images.map((image) => (
				<div key={image.id} className="cchub-image-preview-item">
					<img
						src={`data:${image.mimeType};base64,${image.data}`}
						alt="Attached image"
						className="cchub-image-preview-thumbnail"
					/>
					<button
						className="cchub-image-preview-remove"
